  ...
  Widget getDrawerProfileImage1(widthHeight, User user) {
    return Container(
        ...
        child: Center(
          ...
          fit: BoxFit.cover,
          imageUrl: '${Connect.filesUrl}${user.profileImage}',
        ...
        child: Center(
          child: CircleAvatar(
              ...
              backgroundImage: CachedNetworkImageProvider(
                  '${Connect.filesUrl}${user.profileImage}')),
        ));
  }
...
//  void showActionDialog1(String message, VoidCallback yesVoidCallback, VoidCallback noVoidCallback) {
//    showDialog(
//        context: context,
//        builder: (BuildContext context) {
