...
import 'package:mesbro_chat_flutter_app/bloc_patterns/edit_profile_bloc_patterns/edit_contact_bloc.dart';
import 'package:mesbro_chat_flutter_app/bloc_patterns/edit_profile_bloc_patterns/edit_location_bloc.dart';
import 'package:mesbro_chat_flutter_app/models/place.dart';
import 'package:mesbro_chat_flutter_app/network/user_connect.dart';
import 'package:mesbro_chat_flutter_app/utils/location_details.dart';
import 'package:mesbro_chat_flutter_app/utils/data_collection.dart';
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        autovalidate: true,
                        controller: _alternateMobileTextEditingController,
                        validator: (String value) {
                          if (value != '' && !_mobileNoRegExp.hasMatch(value)) {
                  ...
                  children: <Widget>[
                    ...
                    Container(
                        ...
                        child: TextFormField(
                            ...
                            autovalidate: true,
                            controller: _alternateEmailTextEditingController,
                            validator: (String value) {
                              if (value != '' &&
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        autovalidate: true,
                        controller: _alternateWebsiteTextEditingController,
                        validator: (String value) {},
                        decoration: InputDecoration(
