...
import 'package:mesbro_chat_flutter_app/bloc_patterns/edit_profile_bloc_patterns/edit_personal_bloc.dart';
                      ...
                      builder: (BuildContext context,
                        ...
                        return Container(
                          ...
                          child: DropdownButton<String>(
                            ...
                            value: asyncSnapshot.data,
                            items:
                                _dataCollection.gendersList.map((String value) {
                              return DropdownMenuItem(
                                value: value,
                                child: Text(value),
                              );
                  ...
                  return RaisedButton(
                      ...
                      onPressed: asyncSnapshot.hasData
                          ? () {
                              ...
                              //print(
                                  // '~~~ au: ${Connect.currentUser.au} ${Connect.currentUser.name}');
