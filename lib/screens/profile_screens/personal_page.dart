            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                  margin: EdgeInsets.only(top: 3.0),
                  child: Text(
                    '${_dateFormat.format(DateTime.parse(userMap['dateOfBirth']))}',
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                  margin: EdgeInsets.only(top: 3.0),
                  child: Text(
                    '${userMap['countryCode']} ${userMap['mobile']}',
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                    margin: EdgeInsets.only(top: 3.0),
                    child: Text(
                        '${_dateFormat.format(DateTime.fromMillisecondsSinceEpoch(userMap['addedAt']))}',
                        ))
              ],
            ),
          ),
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                    margin: EdgeInsets.only(top: 3.0),
                    child: Text(
                        '${_dateFormat.format(DateTime.fromMillisecondsSinceEpoch(userMap['lastModifiedAt']))}',
                        ))
              ],
            ),
          ),
