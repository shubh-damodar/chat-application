...
import 'package:mesbro_chat_flutter_app/bloc_patterns/idm_bloc_patterns/login_bloc.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<bool> _onWillPop() async {
    ...
    if (previousScreen == 'chat_contact_options_page') {
            ...
            child: Center(
              child: Column(
                children: <Widget>[
                  ...
                  Image(
                    image: AssetImage("assets_image/mesbro.png"),
                    width: 150.0,
                  ),
                  Padding(
    ...
    Future.delayed(Duration.zero, () {
      ...
      if (mapResponse['code'] == 200) {
        ...
        if (SharedPrefManager.usersList.length > 0 &&
            widget.previousScreen == 'chat_contact_options_page') {
          ...
          if(!_isAlreadyLoggedIn)  {
            SharedPrefManager.setCurrentUser(User(
              ...
              profileImage: userMap['profileImage'].toString(),
              ...
              _navigationActions
                  .navigateToScreenNameRoot('chat_contact_options_page');
            });
          }
        } else {
          SharedPrefManager.setCurrentUser(User(
