...
import 'package:mesbro_chat_flutter_app/validators/otp_validators.dart';

class RegisterVerifyMobileNumberBloc with OtpValidators {
  StreamController<Map<String, dynamic>> _verifyStreamController =
      StreamController<Map<String, dynamic>>();

  StreamSink<Map<String, dynamic>> get verifyStreamSink =>
      _verifyStreamController.sink;

  Stream<Map<String, dynamic>> get verifyStream =>
      _verifyStreamController.stream;
  ...
  void verifyMobileNumber(String otpToken, String otp) async {
    ...
    _connect
        .sendPost(mapBody, Connect.otpValidate)
  ...
  Future<String> generateOTP(String userId) async {
    ...
    Map<String, dynamic> mapResponse =
        await _connect.sendPost(mapBody, Connect.otpGenerate);
  ...
  void resendOTP(String otpToken) async {
    ...
    Connect _connect = Connect();
    _connect
        .sendGet('${Connect.otpResend}$otpToken')
        .then((Map<String, dynamic> mapResponse) {});
  }
