...
import 'package:mesbro_chat_flutter_app/validators/edit_location_validators.dart';
...
class EditLocationBloc with EditLocationValidators {
  ...
  EditLocationBloc(Map<String, dynamic> sentUserMap) {
    ...
    cityStreamSink.add(
        _userMap['address']['city'] == null ? '' : _userMap['address']['city']);
  ...
  final BehaviorSubject<String> _addressLine1BehaviorSubject =
      ...
      _addressLine2BehaviorSubject = BehaviorSubject<String>(),
      _searchLocationBehaviorSubject = BehaviorSubject<String>(),
  ...
  final StreamController<Map<String, dynamic>> _editLocationStreamController =
  ...
  StreamSink<Map<String, dynamic>> get editLocationStreamSink =>
      _editLocationStreamController.sink;

  Stream<String> get addressLine1Stream => _addressLine1BehaviorSubject.stream
      .transform(addressLine1StreamTransformer);

  Stream<String> get addressLine2Stream => _addressLine2BehaviorSubject.stream
  ...
  Stream<Map<String, dynamic>> get editLocationStream =>
      _editLocationStreamController.stream;

  Observable<bool> get editLocationCheckStream =>
      Observable.combineLatest2(addressLine1Stream, addressLine2Stream,
