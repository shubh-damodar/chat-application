...
import 'package:mesbro_chat_flutter_app/network/file_connect.dart';
...
import 'package:mesbro_chat_flutter_app/validators/photo_validators.dart';
...
class ProfileBloc with PhotoValidators {
  ...
  void loadUserDetails() {
    ...
    //print(
    // '~~~ loadUserDetails: ${user.profileImage} ${user.bannerImage} ${user.name}');
  ...
  void changeProfileCoverImage(String imageCategory) async {
    ...
    if (mapResponseConfirm['code'] == 200) {
      if (imageCategory == 'profileImage') {
        ...
        Connect.currentUser.profileImage =
