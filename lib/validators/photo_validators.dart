...
mixin PhotoValidators {
  StreamTransformer profileImagePhotoFileStreamTransformer =
      StreamTransformer<File, File>.fromHandlers(
          handleData: (File profileImageFile, EventSink<File> eventSink) {
    if (profileImageFile != null) {
      eventSink.add(profileImageFile);
    }
  });
  StreamTransformer bannerImagePhotoFileStreamTransformer =
      StreamTransformer<File, File>.fromHandlers(
